...
public class OutDeViewSelectPDAndCtm extends JFrame {
	...
	public OutDeViewSelectPDAndCtm() {
		...
		lblListPd.setBounds(71, 31, 41, 18);
		...
		btnListPd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					ArrayList<VOProduct> listpd = new OutViewDAO().getProductList(searchPd);
		...
		lblListCtm.setBounds(71, 31, 54, 18);
		...
		btnListCtm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					ArrayList<VOCustomer> listctm = new OutViewDAO().getCustomerList(searchCtm);
		...
		btnListCtm.setBounds(122, 61, 61, 24);
		...
		btnInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new OutViewInsertDe().setLabel((String)tableListPd.getValueAt(pdrow, 0), (String)tableListCtm.getValueAt(ctmrow, 0));
				dispose();
			}
		});
		btnInsert.setFont(new Font("굴림", Font.BOLD, 18));
		btnInsert.setBounds(317, 307, 105, 34);
