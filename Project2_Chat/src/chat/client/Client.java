...
public class Client implements Runnable {
	...
	public static void main(String[] args) {
		System.out.println("클라이언트 실행 시작");
		new Client();
	...
	// 선택한 채팅방의 사용자 리스트
		...
		private void whisper(String id, String nick, String msg) {
			...
			//@@@귓속말시 스크롤바 밑으로
            int pos =  waitRoom.waitRoomArea.getText().length();
            waitRoom.waitRoomArea.setCaretPosition(pos);
		}
